...
2. **Feature/Suggestion recommendation based on crowd-source data** (suspended)
...
3. **Intelligent reminder system based on multi-model data**  (ongoing)

4. **Large Scale Contact Tracing for Covid-19**(Ongoing)

5. **Multiple Type Question Answering System**(ongoing)
